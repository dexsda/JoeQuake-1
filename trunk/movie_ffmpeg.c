...
#define CAP_FFMPEG_DEFAULT_VIDEO_ENCODE	"-c:v libx265 -preset fast -crf 16 -pix_fmt yuv420p"
 ...
 */
static qboolean Movie_FFmpeg_CopyTrimmedEncodeArg (
	const char *raw,
...
#define MOVIE_ARGC 256
#define MOVIE_ARGLEN 128
